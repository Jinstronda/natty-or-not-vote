...
const Merch = () => {
  ...
  const shopifyGridRef = useRef<HTMLDivElement>(null);
  ...
  useEffect(() => {
    ...
    // Inject Shopify store HTML after mount
    if (shopifyGridRef.current) {
      shopifyGridRef.current.innerHTML = `
        <shopify-store 
          ...
          language="en"
        >
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8 max-w-7xl mx-auto">
